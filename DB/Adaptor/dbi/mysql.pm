package Music::DB::Adaptor::dbi::mysql;

# VERSION: $Id: mysql.pm,v 1.1.1.1 2004/09/20 00:50:52 todd Exp $

use strict;
use DBI;

use Music::DB::Util::Rearrange;
use Music::DB::DataTypes::Song;
...
sub generic_search {
  ...
  my $temp = 'Music::DB::DataTypes::' . ucfirst $class;
...
compatible with Music::DB.  It inherits from Music::DB.  In addition 
to implementing the abstract SQL-generating methods of
Music::DB::Adaptor::dbi, this module also implements the data
loading functionality of Music::DB.
...
L<Music::DB>,L<Music::DB::Web>, L<Apache::MP3>
